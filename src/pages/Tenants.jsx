        ...
        <div className="container tenants">
            <div className="row">
                ...
                <form className="form">
                    ...
                    <div Style="max-height:150px;"className="col-lg-12">
                    <button className="submit-btn">Прикрепить файл</button>
                    <button Style="float:right" className="submit-btn">Отправить</button>
                    </div>
